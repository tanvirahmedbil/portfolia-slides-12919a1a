          ...
          {featuredProjects.map((project, index) => <article key={project.id} className={`project-card animate-fade-in-up animation-delay-${(index + 1) * 100}`}>
              ...
              <div className="flex items-start justify-between gap-4 mb-6">
                <div className="flex items-center gap-4">
                  {/* Logo */}
                  <div className="w-16 h-16 border-2 flex items-center justify-center overflow-hidden p-2.5 transition-transform duration-200 hover:scale-105 rounded-full shadow-lg border-muted gap-0 bg-muted-foreground">
